# Responsible Generative AI. Deal With harmful Content. Pre-release Review. Content Filters
...
## Four Stages in process of responsible AI solution creation
...
3. Submit the prompts to the system and retrieve the generated output.
4. Apply pre-defined criteria to evaluate the output and categorize it according to the level of potential harm it contains.
...
![image](https://github.com/Glareone/OpenAI-and-ChatGPT-meet-.Net/assets/4239376/5716ddc6-3c33-4cb9-b0b0-9f0be087e260)
1. Model
...
2. Safety System The safety system layer includes platform-level configurations and capabilities that help mitigate harm.
...
3. Metaprompt and grounding. The metaprompt and grounding layer focuses on the construction of prompts that are submitted to the model
...
4. User experience. Designing the application user interface to constrain inputs to specific subjects or types, or applying input and output validation can mitigate the risk of potentially harmful responses.
